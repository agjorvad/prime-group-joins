...
SELECT "warehouse_product"."product_id", "warehouse_product"."warehouse_id", "warehouse"."warehouse", "products"."description" FROM "warehouse_product"
...
SELECT "orders"."address_id", "orders"."total", "customers"."first_name", "customers"."id", "addresses"."customer_id", "addresses"."id" FROM "addresses"
